...
#                print(return_ohlc)  # Print the fetched historical data
    ...
    def __open_callback(self):
        ...
        broker_tokens= ['NSE|33','NSE|29']  # Example tokens, replace with actual tokens you want to subscribe to
        ...
        self._WebSocketConnectionStatus()  # Update WebSocket connection status when the connection is opened to True
